...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] =  LAYOUT_split_3x6_3(
      KC_ESC,       KC_J,  KC_L,  KC_Q,  KC_GRV,  KC_G,                            KC_B,  KC_QUOT,  KC_P,    KC_U,   KC_K,   KC_PSCR,
      KC_TAB, KC_R, LALT_T(KC_S), LSFT_T(KC_A), LCTL_T(KC_D), KC_T,              KC_M, RCTL_T(KC_N), RSFT_T(KC_E), RALT_T(KC_O), KC_I, KC_MPLY,
      OSM(KC_LSFT), KC_Z,  KC_X,  KC_C,  KC_V,  KC_COMM,                            KC_DOT,  KC_H,  KC_F, KC_Y, KC_W, KC_CIRC,
